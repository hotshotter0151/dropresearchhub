...
{"name":"string","niche":"Pet|Home|Beauty|Fitness|Kitchen|Outdoor|Baby|Office|Tech|Fashion","emoji":"emoji","stage":"Emerging","season":"Evergreen|Summer peak|Winter peak","grade":"A+|A|B|C","trendScore":number,"problemScore":number,"saturationRisk":"Low|Medium|High","competitionLevel":"Low|Medium|High","emergingScore":number,"supplierCost":"£X–£X","sellingPrice":"£X–£X","margin":"XX%","targetCustomer":"one sentence","whyEmerging":"max 20 words","whyNow":"max 20 words","whyNowDetailed":"2-3 sentences explaining specifically why this product is emerging right now based on consumer behaviour, content signals or market timing. Be honest this is AI assessment not live data.","problemSolved":"max 15 words","mainAngle":"max 15 words","tiktokAngle":"max 20 words","metaAngle":"max 20 words","verdict":"Strong Opportunity|Watch List|Avoid","verdictReason":"max 20 words","whyItCouldWork":["point 1","point 2","point 3"],"risks":["risk 1","risk 2","risk 3"],"bundleIdea":"max 15 words","redFlags":"max 15 words or None","aliSearchTerm":"term","googleTrendsKeyword":"broad 1-2 word keyword","supplierSearchTerms":["exact aliexpress search term 1","exact aliexpress search term 2","exact aliexpress search term 3"],"scoring":{"trendGrowth":number,"problemSolving":number,"videoPotential":number,"profitMargin":number,"competitionLevel":number,"audienceSize":number},"bgColor":"#EFF6FF","growthData":[{"label":"W1","value":15},{"label":"W2","value":25},{"label":"W3","value":38},{"label":"W4","value":54},{"label":"W5","value":70},{"label":"W6","value":84}],"growthCurve":[12,20,31,45,62,75,83],"windowClosesWeek":8,"launchReadiness":[{"check":"Demonstrable in under 10 seconds of video","pass":true},{"check":"Solves a problem most people recognise instantly","pass":true},{"check":"Available on AliExpress under £10","pass":true},{"check":"Sellable between £20-£60","pass":true},{"check":"Not already saturating UK TikTok feeds","pass":true},{"check":"Strong impulse-buy angle","pass":true},{"check":"Lightweight and easy to ship","pass":true},{"check":"No legal or compliance issues","pass":true}]}

IMPORTANT for growthCurve — 7 numbers reflecting the ACTUAL trajectory of this specific product. Make each product different:
...
IMPORTANT for windowClosesWeek — be specific: fast-rising=5-6, steady=9-10, slow burn=11-12

IMPORTANT for launchReadiness — be honest. If shipping is slow or compliance is borderline set those to false. Do not make everything true.`;
